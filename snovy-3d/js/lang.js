...
const LANG = {
    sk: {
        ...
        medium: '🟡 Stredná',
        hard: '🔴 Ťažká',
        diffCustom: '⚙️ Vlastná',
        customDiffTitle: '⚙️ Vlastná obtiažnosť',
        customDiffEdit: '⚙️ Upraviť vlastnú obtiažnosť',
        diffParams: { lives: 'Životy', enemyBase: 'Nepriatelia na začiatku', enemyPerRealm: 'Pribúdanie / ríša', enemySpeed: 'Rýchlosť nepriateľov', invinc: 'Nezraniteľnosť (s)', enemySleepTime: 'Čas spánku (s)', bossHpMul: 'HP bossa (×)' },
        visualMode: 'Vizuál:',
        visual3d: '3D modely',
        visual2d: '2D billboardy',
        controls3d: '🎮 Šípky/WSAD = pohyb · Space = skok · Ctrl/Ľ-myš = baterka · P-myš = kamera (klik = skok)',
    ...
    en: {
        ...
        hard: '🔴 Hard',
        diffCustom: '⚙️ Custom',
        customDiffTitle: '⚙️ Custom difficulty',
        customDiffEdit: '⚙️ Edit custom difficulty',
        diffParams: { lives: 'Lives', enemyBase: 'Enemies at start', enemyPerRealm: 'Added per realm', enemySpeed: 'Enemy speed', invinc: 'Invincibility (s)', enemySleepTime: 'Sleep time (s)', bossHpMul: 'Boss HP (×)' },
        visualMode: 'Visual:',
        visual3d: '3D models',
        visual2d: '2D billboards',
        controls3d: '🎮 Arrows/WASD = move · Space = jump · Ctrl/LMB = flashlight · RMB = camera (click = jump)',
