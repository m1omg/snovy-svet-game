...
const LANG = {
    sk: {
        ...
        diffParams: { lives: 'Životy', enemyBase: 'Nepriatelia na začiatku', enemyPerRealm: 'Pribúdanie / ríša', enemySpeed: 'Rýchlosť nepriateľov', invinc: 'Nezraniteľnosť (s)', enemySleepTime: 'Čas spánku (s)', bossHpMul: 'HP bossa (×)', jumpMul: 'Výška skoku (×)' },
        visualMode: 'Vizuál:',
        visual3d: '3D modely',
        ...
        camFree: '🎥 Voľná',
        camSpyro: '🐉 Spyro',
        continueBtn: '▶ Pokračovať v sne',
        exportSave: '💾 Exportovať',
        importSave: '📂 Importovať',
        exportSavePause: '💾 Exportovať uloženie',
        saveImportErr: 'Neplatný súbor uloženia.',
        controls3d: '🎮 Šípky/WSAD = pohyb · Space = skok · Ctrl/Ľ-myš = baterka, pohyb myši = mierenie · P-myš = kamera mimo streľby (klik = skok)',
        ...
        joystick: 'Joystick',
        devMode: 'Dev mód',
        captureMouse: 'Zachytiť myš',
        autoAim: 'Auto-mierenie',
        mouseSensitivity: 'Citlivosť myši',
        invertMouseY: 'Invertovať myš Y',
        captureHint: '🖱 Myš zachytená — pohyb = kamera, pri baterke = mierenie · Ľ-myš = baterka · P-myš = skok · Alt = uvoľniť · koliesko = priblíženie',
        on: 'Zap',
        off: 'Vyp',
    ...
    en: {
        ...
        diffParams: { lives: 'Lives', enemyBase: 'Enemies at start', enemyPerRealm: 'Added per realm', enemySpeed: 'Enemy speed', invinc: 'Invincibility (s)', enemySleepTime: 'Sleep time (s)', bossHpMul: 'Boss HP (×)', jumpMul: 'Jump height (×)' },
        visualMode: 'Visual:',
        visual3d: '3D models',
        ...
        camFree: '🎥 Free',
        camSpyro: '🐉 Spyro',
        continueBtn: '▶ Continue dream',
        exportSave: '💾 Export',
        importSave: '📂 Import',
        exportSavePause: '💾 Export save',
        saveImportErr: 'Invalid save file.',
        controls3d: '🎮 Arrows/WASD = move · Space = jump · Ctrl/LMB = flashlight, mouse move = aim · RMB = camera when not firing (click = jump)',
        ...
        captureHint: '🖱 Mouse captured — move = camera, while firing = aim · LMB = flashlight · RMB = jump · Alt = release · wheel = zoom',
        on: 'On',
        off: 'Off',
