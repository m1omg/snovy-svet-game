...
const LANG = {
    sk: {
        ...
        controls3d: '🎮 Šípky/WSAD = pohyb · Space = skok · Ctrl/Ľ-myš = baterka (mieri myšou) · P-myš = kamera (klik = skok)',
        ...
        captureHint: '🖱 Myš zachytená — pohyb = kamera a mierenie · Ľ-myš = baterka · P-myš = skok · Alt = uvoľniť · koliesko = priblíženie',
        on: 'Zap',
        off: 'Vyp',
    ...
    en: {
        ...
        controls3d: '🎮 Arrows/WASD = move · Space = jump · Ctrl/LMB = flashlight (mouse aim) · RMB = camera (click = jump)',
        ...
        captureHint: '🖱 Mouse captured — move = camera and aim · LMB = flashlight · RMB = jump · Alt = release · wheel = zoom',
        on: 'On',
        off: 'Off',
