...
const LANG = {
    sk: {
        ...
        controls3d: '🎮 Šípky/WSAD = pohyb · Space = skok · Ctrl/Ľ-myš = baterka, pohyb myši = mierenie · P-myš = kamera (klik = skok)',
    ...
    en: {
        ...
        controls3d: '🎮 Arrows/WASD = move · Space = jump · Ctrl/LMB = flashlight, mouse move = aim · RMB = camera (click = jump)',
