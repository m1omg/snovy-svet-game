...
const LANG = {
    sk: {
        ...
        captureHint: '🖱 Myš zachytená — pohyb = kamera · Ľ-myš = baterka · P-myš = skok · Alt = uvoľniť · koliesko = priblíženie',
        on: 'Zap',
        off: 'Vyp',
    ...
    en: {
        ...
        captureHint: '🖱 Mouse captured — move = camera · LMB = flashlight · RMB = jump · Alt = release · wheel = zoom',
        on: 'On',
        off: 'Off',
