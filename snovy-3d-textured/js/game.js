...
const PLATFORM_TEXTURE_PATHS = { purpleMist: 'assets/platform-purple-mist.png?v=34-textured' };
...
const BUILD_ID = 'build 34-textured';
let frameCount = 0;
let lastKeyCode = '–';
...
function addPlatform(x, y, z, w, d, theme) {
    ...
    const forcefield = !!textureMap;
    const mat = new THREE.MeshStandardMaterial({
        color: forcefield ? 0xf0d6ff : new THREE.Color(theme.platform),
        map: textureMap,
        emissiveMap: textureMap,
        emissive: new THREE.Color(theme.accent).multiplyScalar(forcefield ? 0.5 : 0.12),
        emissiveIntensity: forcefield ? 1.35 : 1.0,
        transparent: forcefield,
        opacity: forcefield ? 0.72 : 1.0,
        depthWrite: !forcefield,
        roughness: forcefield ? 0.24 : 0.85,
        metalness: forcefield ? 0.0 : 0.05
    });
